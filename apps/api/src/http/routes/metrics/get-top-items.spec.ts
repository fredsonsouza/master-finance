...
describe('Get Top Items Metrics Unit Test', () => {
  ...
  test('should return top items for a MANAGER', async () => {
    ...
    expect(response.json()).toEqual({
      items: [
        { itemId: '323e4567-e89b-12d3-a456-426614174001', itemName: 'Item Alpha', totalValue: 500 },
        { itemId: '323e4567-e89b-12d3-a456-426614174002', itemName: 'Item Beta', totalValue: 200 },
      ]
    })
  })
