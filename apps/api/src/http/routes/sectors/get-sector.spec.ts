...
describe('Get Sector Unit Test', () => {
  ...
  test('should allow EMPLOYEE to view sector within their unit', async () => {
    ...
    vi.mocked(prisma.sector.findUnique).mockResolvedValueOnce({
      ...
      name: 'Reception',
      unitId: '223e4567-e89b-12d3-a456-426614174001', // Same unit as employee
      createdAt: date,
      updatedAt: date,
    } as any)
  ...
  test('should block EMPLOYEE from viewing sector outside their unit', async () => {
    vi.mocked(prisma.user.findUnique).mockResolvedValueOnce({
      id: '123e4567-e89b-12d3-a456-426614174000',
      role: 'EMPLOYEE',
      unitId: '223e4567-e89b-12d3-a456-426614174001',
    ...
    vi.mocked(prisma.sector.findUnique).mockResolvedValueOnce({
      id: '323e4567-e89b-12d3-a456-426614174002',
      name: 'Reception',
      unitId: '423e4567-e89b-12d3-a456-426614174003', // Different unit
    } as any)
    ...
    expect(response.json()).toEqual({ message: 'You are not allowed to view this sector.' })
  })
})
