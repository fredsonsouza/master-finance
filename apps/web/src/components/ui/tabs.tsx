...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={`inline-flex h-10 items-center justify-center rounded-md bg-surface-container p-1 text-on-surface-variant ${className || ''}`}
    {...props}
  />
))
